...
type HashServiceClient interface {
	...
	CheckHash(ctx context.Context, in *HashRequest, opts ...grpc.CallOption) (*HashResponseOther, error)
}
...
type HashServiceServer interface {
	...
	CheckHash(context.Context, *HashRequest) (*HashResponseOther, error)
...
func (UnimplementedHashServiceServer) CreateHash(context.Context, *HashRequest) (*HashResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateHash not implemented")
}
func (UnimplementedHashServiceServer) GetHash(context.Context, *HashRequest) (*HashResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHash not implemented")
}
func (UnimplementedHashServiceServer) CheckHash(context.Context, *HashRequest) (*HashResponseOther, error) {
